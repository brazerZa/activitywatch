...
#define MyAppName "Malachi ActivityWatch"
#define MyAppVersion GetEnv('AW_VERSION')
#define MyAppPublisher "Malachi Contractors Ltd"
#define MyAppURL "https://malachi.co.uk/"
...
OutputDir={#DistDir}
OutputBaseFilename=activitywatch-malachi-setup
...
Name: "StartMenuEntry" ; Description: "Start Malachi ActivityWatch when Windows starts"; GroupDescription: "Windows Startup"; MinVersion: 4,4;
